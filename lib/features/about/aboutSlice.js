...
export const {setAbout,setRequisite,setContacts,setPublicOffer,setAgreement,setAboutInfo,setRequisitesInfo} = AboutSlice.actions;
...
export const RequisitesData = () => {
    ...
    async function getRequisitesInfo() {
        try {
         const responseRequisites = await axios.get("https://quitystrapi.onrender.com/api/requisites?populate=*")
