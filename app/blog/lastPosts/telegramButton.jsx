    ...
    return (
        <div className={t.wrapper}>
           <div className={t.telegramButton__body}>
              ...
              <Image src={BlogImages.telegramLogo} width={80} height={80}/>
              <button className={t.button}>Перейти</button>
              <Image src={BlogImages.telegramButtonBG} width={296} height={280} className={t.bg}/>
              <Image src={BlogImages.telegramButtonBGblue} width={250} height={180} className={t.bgBlue}/>
        </div>
        </div>
    )
}
