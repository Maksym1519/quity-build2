    ...
    return (
        <div className={c.wrapper}>
            ...
            <div className={c.coupon__body}>
               <Image src={CouponImages.yellowBg} width={1280} height={320} className={c.yellowBg} alt="icon"/>
               <Image src={CouponImages.blueBg} width={850} height={320} className={c.blueBg} alt="icon"/>
               <Image src={CouponImages.discount} width={554} height={272} className={c.discount} alt="icon"/>
