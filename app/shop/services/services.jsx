      ...
      <div className={s.services__body}>
        ...
        <div className={s.items__wrapper}>
          ...
          <div className={s.item}>
            <Image
              src={shopServicesIcones.catalog}
              width={88}
              height={88}
              alt="icon"
            />
          ...
          <div className={s.item}>
            <Image
              src={shopServicesIcones.payment}
              width={88}
              height={88}
              alt="icon"
            />
          ...
          <div className={s.item}>
            <Image
              src={shopServicesIcones.garantee}
              width={88}
              height={88}
              alt="icon"
            />
            <div className={s.text__wrapper}>
              ...
              <p className={s.text}>
                ...
                качестве и состоянии оборудования{" "}
                <span className={s.colored}>Смотреть документы</span>
              </p>
            </div>
          </div>
          {/* //item4--------------------------------------------------------------------------- */}
          <div className={s.item}>
            <Image
              src={shopServicesIcones.delivery}
              width={88}
              height={88}
              alt="icon"
            />
            <div className={s.text__wrapper}>
              ...
              <p className={s.text}>
                Доставляем по всей Украины транспортными компаниями по тарифам
                перевозчиков
              </p>
            </div>
          </div>
          ...
          <div className={s.item}>
            ...
            <div className={s.text__wrapper}>
              ...
              <p className={s.text}>
                Вместе с Вами проверим работу майнера, покажем все документы или
                снимем видео с проверкой и вышлем онлайн
              </p>
            </div>
          </div>
          {/* //item6--------------------------------------------------------------------------- */}
