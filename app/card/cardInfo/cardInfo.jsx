    ...
    <div className={c.cardInfo__wrapper}>
      <div className={c.cardInfo__body}>
        <div className={c.cardInfo__header}>
          <h3 className={c.mainTitle}>{reduxInfo ? reduxInfo.attributes.title : ""}</h3>
          ...
          <div className={c.options__wrapper}>
            ...
            <div className={c.optionLine}>
              ...
              <div className={c.options__body}>
                <div className={reduxInfo && reduxInfo.attributes.w === "1100" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.w === "1100" ? reduxInfo.attributes.w : "1100"}W</div>
                <div className={reduxInfo && reduxInfo.attributes.w === "1200" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.w === "1800" ? reduxInfo.attributes.w : "1800"}W</div>
                <div className={reduxInfo && reduxInfo.attributes.w === "2200" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.w === "2200" ? reduxInfo.attributes.w : "2200"}W</div>
                <div className={reduxInfo && reduxInfo.attributes.w === "3150" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.w === "3150" ? reduxInfo.attributes.w : "3150"}W</div>
              </div>
            </div>
            <div className={c.optionLine}>
              <h4 className={c.optionTitle}>Хешрейт</h4>
              <div className={c.options__body}>
              <div className={reduxInfo && reduxInfo.attributes.ths === "30" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.ths=== "30" ? reduxInfo.attributes.ths : "30"}Th/s</div>
                <div className={reduxInfo && reduxInfo.attributes.ths === "56" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.ths === "56" ? reduxInfo.attributes.ths : "56"}Th/s</div>
                <div className={reduxInfo && reduxInfo.attributes.ths === "84" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.ths === "84" ? reduxInfo.attributes.ths : "84"}Th/s</div>
              </div>
            </div>
            <div className={c.optionLine}>
              <h4 className={c.optionTitle}>Состояние</h4>
              <div className={c.options__body}>
              <div className={reduxInfo && reduxInfo.attributes.condition === "new" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.condition === "new" ? reduxInfo.attributes.condition : "new"}</div>
                <div className={reduxInfo && reduxInfo.attributes.condition === "used" ? c.optionItemActive : c.optionItem}>{reduxInfo.attributes.condition === "used" ? reduxInfo.attributes.condition : "used"}</div>
              </div>
            </div>
          </div>
          {/* //------------------------------------------------------------------ */}
          <div className={c.buyInfo__wrapper}>
            <div className={c.buyInfo__body}>
              <div className={c.priceWrapper}>
                <span className={c.price}>{reduxInfo && reduxInfo.attributes.price}</span>
